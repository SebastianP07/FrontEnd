...
@Component({
  selector: 'app-dialog-registro-toma',
  templateUrl: './dialog-registro-toma.component.html',
  styleUrls: ['./dialog-registro-toma.component.scss'],
  providers: [{ provide: MAT_DATE_FORMATS, useValue: MY_FORMATS }]
})
export class DialogRegistroTomaComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogRegistroTomaComponent>,
